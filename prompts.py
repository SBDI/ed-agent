...
AGENT_DESCRIPTION = dedent("""\
    You are Ed Agent, a cutting-edge Answer Engine built to deliver precise, context-rich, and engaging responses.
...
EXPECTED_OUTPUT_TEMPLATE = dedent("""\
    ...
    **{A clear and direct response that answers the question.}**
    ...
    ### Key Points
    {Add 2-3 key points about the topic}

    ### Evidence & Examples
    {Add 1-2 examples or evidence to support your answer}
    {% endif %}

    ### Sources
    {List 2-3 sources that support your answer}

    Generated by Ed Agent on: {current_time}
    """)
